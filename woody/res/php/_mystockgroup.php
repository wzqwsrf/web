...
function _getMetaDescriptionStr($strPage)
{
	$ar = array('abcompare' => AB_COMPARE_DISPLAY.'工具，按A/B价格比和B/A价格比排序。B股的正式名称是人民币特种股票，以外币认购和买卖，在中国上海和深圳证券交易所上市交易。',
				  ...
				  'biotech' => BIOTECH_GROUP_DISPLAY.'基金的净值估算。使用XBI的净值估值，目前包括SZ159502标普生物科技ETF和SZ161127标普生物科技LOF。',
				  ...
				  'lof' => '本网站有估值的'.LOF_ALL_DISPLAY.'汇总，方便申购不起ETF的穷人发现套利机会。使用拖拉机自动化软件前注意查询基金的限购状态和限购方式等具体内容。',
				  ...
				  'overnight' => OVERNIGHT_DISPLAY.'LOF数据汇总，方便调试软件、对比两边软件的实时折价溢价信息以及在消息过多的时候快速筛选和定位有夜盘实时跨市场套利机会的基金。',
...
function _getTitleStr($strPage)
{
	...
	$ar = array('abcompare' => AB_COMPARE_DISPLAY,
				  'adrhcompare' => ADRH_COMPARE_DISPLAY,
			  	  ...
			  	  'biotech'	=> BIOTECH_GROUP_DISPLAY.$strTool,
