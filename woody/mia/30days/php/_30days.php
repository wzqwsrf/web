...
{
	LayoutBegin();
	EchoHtmlElement(GetPhotoDirLink(20141211, $bChinese, false).' '.GetMia30DaysLink($bChinese).' '.GetCategoryLinks(Get30DaysMenuArray($bChinese), PATH_MIA_30DAYS, $bChinese));
	LayoutEnd();
